<div>
            ...
            <div class="card-body">
                <ul id="trending">
                    @foreach ($products as $product)
                        <li class='hits'><a href="{{ route('getProduct', $product->id) }}">{{ $product->name }}</a>
                        </li>
                    @endforeach
                </ul>
            </div>
    ...
    <div class="row mt-2">
        <div class="card primary w-100">
            ...
            <div class="card-body">
                <p class="text-justify">Get free updates on the latest products and discounts, straight to your inbox.
                </p>
